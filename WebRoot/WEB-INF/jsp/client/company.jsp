	  		...
	  		<div class="row">
	  			...
	  			<div class="col-sm-3">
	  				...
	  				<ul class="nav nav-pills nav-stacked" role="tablist" id="nav">
	  					  <li role="presentation" class="pre active"><a href="#companyIntroduction" >公司介绍</a></li>
						  <li role="presentation" class="pre"><a href="#business" >主要业务与关联公司</a></li>
						  <li role="presentation" class="pre"><a href="#history" >历史与里程碑</a></li>
					</ul>
	  			...
	  			<div class="col-sm-8">
					...
					<div class="row">
				  		<div class="page-header" style="margin-left: 30px" id="business">
				  			<h2 class="head-leader">主要业务与关联公司</h2>
				  		</div>
			  			<p>
			  			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;阿里巴巴集团经营多元化的互联网业务，致力为全球所有人创造便捷的网上交易渠道。自成立以来，发展了消费者电子商务、
			  				网上支付、B2B网上交易市场及云计算等领先业务。阿里巴巴集团现有25个事业部，
					...
					<div class="row">
				  		<div class="page-header" style="margin-left: 30px" id="history">
				  			<h2 class="head-leader">主要业务与关联公司</h2>
				  		</div>
			  			<p>
			  			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;阿里巴巴集团经营多元化的互联网业务，致力为全球所有人创造便捷的网上交易渠道。自成立以来，发展了消费者电子商务、
