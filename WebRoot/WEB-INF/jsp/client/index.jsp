...
<body
	...
	<div style="margin-top: 50px">
		<img width="100%"
			src="${pageContext.request.contextPath}/image/index-im1.jpg">
	</div>
									...
									<td>
										<div class="btn-group">
											<button type="button" class="btn btn-default"
												name="workPlace">不限</button>
											<button type="button" class="btn btn-default "
												name="workPlace">哈尔滨</button>
											<button type="button" class="btn btn-default "
												name="workPlace">北京</button>
											<button type="button" class="btn btn-default"
												name="workPlace">上海</button>
										</div>
									</td>
						...
						<table class="table table-striped table-hover" id="table">
							...
							<c:forEach items="${positionList}" var="p">
								<tr class="data">
									...
									<td><fm:formatDate value="${p.endDate}"
					...
					<div class="panel-body">
						<c:forEach items="${positionName }" var="pn">
							<ul style="margin-left: -25">
								<li><a href="position/show/id/${pn.id}">${pn.name}</a> <span
									style="float: right;">${pn.day }天前</span></li>
							</ul>
						</c:forEach>
					</div>
				</div>
				...
				<div class="panel panel-info " style="margin-top: 30px">
					...
					<div class="panel-body">
						...
						<c:forEach items="${companyList }" var="com">
							<ul style="margin-left: -25">
								<li><a
									href="${pageContext.request.contextPath}/client/article/show/id/${com.id}">${com.title}</a>
								</li>
							</ul>
						</c:forEach>
